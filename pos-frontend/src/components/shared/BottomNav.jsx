...
function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] h-16 p-2 flex justify-around">
      <button
        onClick={() => navigate("/")}
        className={`cursor-pointer flex items-center justify-center text-[#ababab] w-50 ${
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order">
        ...
        <div>
          ...
          <button
            ...
            className="w-full bg-[#F6B100] text-[#f5f5f5] rounded-lg py-3 mt-8 hover:text-yellow-700"
          >
            Create Order
          </button>
        </div>
